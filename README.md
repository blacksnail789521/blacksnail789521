## 👋 Hello! I'm Ching (Jason) Chang, Ph.D. ![](https://komarev.com/ghpvc/?username=blacksnail789521)

I am a **Staff ML Research Scientist @ [Pravāh](https://pravah.com/)**. I received my Ph.D. in Computer Science from National Yang Ming Chiao Tung University (NYCU), Taiwan, where I was advised by [Prof. Wen-Chih Peng](https://sites.google.com/site/wcpeng/). Previously, I was a Visiting Graduate Researcher in Computer Science at UCLA, working with [Prof. Wei Wang](http://web.cs.ucla.edu/~weiwang/).  

My research focuses on **Time Series Analysis**, **Large Foundation Models**, **Causal Discovery**, and **Multimodal Reasoning**.  
I have published multiple papers in top AI and data science conferences (NeurIPS, AAAI, CIKM, ICDE) and journals (ACM TIST). I also serve as a reviewer for top-tier venues in the field.
